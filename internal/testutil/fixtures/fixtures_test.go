...
func TestSimpleWorkflow_WithMultipleParameters(t *testing.T) {
	...
	wf := fixtures.SimpleWorkflow(name, command)
...
func TestParallelWorkflow_WithCustomBranchCount(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			wf := fixtures.ParallelWorkflow(tt.branchCount)
...
func TestParallelWorkflow_WithStrategy(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			wf := fixtures.ParallelWorkflow(3, tt.strategy)
...
func TestLoopWorkflow_ForEachType(t *testing.T) {
	wf := fixtures.LoopWorkflow("for_each")
...
func TestLoopWorkflow_WhileType(t *testing.T) {
	wf := fixtures.LoopWorkflow("while")
...
func TestLoopWorkflow_WithCustomItems(t *testing.T) {
	...
	wf := fixtures.LoopWorkflow("for_each", items)
...
func TestConversationWorkflow_HappyPath(t *testing.T) {
	wf := fixtures.ConversationWorkflow()
...
func TestConversationWorkflow_WithCustomProvider(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			wf := fixtures.ConversationWorkflow(tt.provider, tt.model)
...
func TestAllFixtures_ProduceValidWorkflows(t *testing.T) {
	tests := []struct {
		...
		{name: "SimpleWorkflow", fixtureFunc: func() *workflow.Workflow { return fixtures.SimpleWorkflow() }},
		{name: "LinearWorkflow", fixtureFunc: func() *workflow.Workflow { return fixtures.LinearWorkflow() }},
		{name: "ParallelWorkflow", fixtureFunc: func() *workflow.Workflow { return fixtures.ParallelWorkflow() }},
		{name: "LoopWorkflow", fixtureFunc: func() *workflow.Workflow { return fixtures.LoopWorkflow() }},
		{name: "ConversationWorkflow", fixtureFunc: func() *workflow.Workflow { return fixtures.ConversationWorkflow() }},
	}
...
func TestFixtures_AreIndependent(t *testing.T) {
	wf1 := fixtures.SimpleWorkflow()
	wf2 := fixtures.SimpleWorkflow()
...
func TestFixtures_Integration_WithBuilders(t *testing.T) {
	...
	builder := builders.NewWorkflowBuilder()
