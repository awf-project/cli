...
var _ ports.TemplateRepository = (*mocks.MockTemplateRepository)(nil)
...
func TestMockTemplateRepository_GetTemplate_HappyPath(t *testing.T) {
	tests := []struct {
		name         string
		setupFunc    func(*mocks.MockTemplateRepository)
		templateName string
	...
	}{
		{
			...
			setupFunc: func(repo *mocks.MockTemplateRepository) {
