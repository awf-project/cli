...
func (x *HandleEventRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *HandleEventRequest) GetTimestampUnixNanos() int64 {
	if x != nil {
...
func (x *HandleEventRequest) GetSource() string {
	if x != nil {
		return x.Source
	}
	return ""
...
func (x *HandleEventRequest) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *HandleEventRequest) GetPropagationDepth() int32 {
	if x != nil {
...
type HandleEventResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	EmittedEvents []*HandleEventRequest  `protobuf:"bytes,1,rep,name=emitted_events,json=emittedEvents,proto3" json:"emitted_events,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HandleEventResponse) GetEmittedEvents() []*HandleEventRequest {
	if x != nil {
...
const file_proto_plugin_v1_plugin_proto_rawDesc = "" +
	...
	"\texit_code\x18\x03 \x01(\x05R\bexitCode\"\xcf\x02\n" +
	"\x12HandleEventRequest\x12\x0e\n" +
	...
	"\bmetadata\x18\x05 \x03(\v2+.plugin.v1.HandleEventRequest.MetadataEntryR\bmetadata\x12\x18\n" +
	"\apayload\x18\x06 \x01(\fR\apayload\x12+\n" +
	"\x11propagation_depth\x18\a \x01(\x05R\x10propagationDepth\x1a;\n" +
