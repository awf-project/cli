...
func (c *eventServiceClient) HandleEvent(ctx context.Context, in *HandleEventRequest, opts ...grpc.CallOption) (*HandleEventResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "plugin.v1.EventService",
