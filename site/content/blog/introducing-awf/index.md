...
AWF (AI Workflow CLI) is an open-source tool for orchestrating AI agents — Claude, Gemini, Codex, and OpenAI-compatible providers — through declarative YAML workflows.
