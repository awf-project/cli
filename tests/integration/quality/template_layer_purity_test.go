...
func TestMockTemplateRepository_EdgeCases(t *testing.T) {
	tests := []struct {
		name    string
		setup   func(*mocks.MockTemplateRepository) error
		check   func(*testing.T, context.Context, *mocks.MockTemplateRepository)
		wantErr bool
	}{
		{
			name: "empty repository",
			setup: func(r *mocks.MockTemplateRepository) error {
				return nil
			},
			check: func(t *testing.T, ctx context.Context, r *mocks.MockTemplateRepository) {
